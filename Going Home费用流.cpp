...
int n,m,s,t;
const int maxn=300;
const int maxm=maxn*maxn*2;//注意这里还要建反向变，所以要x2
...
signed main()
{
    while(cin>>n>>m)
    {
        ...
        {
            add(i+num_man,t,1,0);add(t,i+num_man,0,0);
        }
        for(int i=1;i<=num_man;i++)
        {
